...
#. Open Visual Studio Code, open the Ivy repo folder and follow the steps listed below:
   ...
   e. You'll be inside the container now, where you can locally run the tests that you've modified by running the command, "pytest test_fle_path::test_fn_name".
...
#. Open Visual Studio Code, open the Ivy repo folder and following the steps listed below:
   ...
   g. You'll be inside the container now, where you can locally run the tests running the command, :code:`pytest test_fle_path::test_fn_name`.

...
when working on Docstrings, Ivy Frontends and Ivy Frontends tests.

**Python - Reference**

`realpython <https://realpython.com/>`_ and `pynative <https://pynative.com/>`_ are 
very useful for any kinds of help regarding python
...
GitHub Co-Pilot can be used to write any bit of code in Ivy. They are often very useful when 
developing code and also helps gets things done faster.
...
Though this may sound odd, a spell-checking extension is very useful to people 
contributing to Ivy when adding docstrings.

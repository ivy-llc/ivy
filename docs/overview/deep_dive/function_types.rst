...
Typically the backend should always be set explicitly though (using :func:`ivy.set_backend` for example), but in this case the efficient backend-specific implementation will always be used if it exists.

...
.. py:function:: ivy.graph_transpile(*objs, source = None, to = None, debug_mode = False, args = None, kwargs = None, params_v = None,)
...
Similar to the ``ivy.trace`` function, ``ivy.graph_transpile`` can be used
...
Likewise, you can use ``ivy.graph_transpile`` to convert entire libraries and modules with just one line of
code!

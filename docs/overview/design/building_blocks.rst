...
For example, the APIs of JAX, PyTorch, and NumPy all have a :code:`logspace` method, but TensorFlow does not provide this functionality. Therefore, we need to construct it using a composition of existing TensorFlow ops like so:

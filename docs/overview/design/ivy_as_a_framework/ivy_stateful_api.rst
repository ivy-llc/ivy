...
Check out the `code <https://github.com/unifyai/ivy/blob/master/ivy/stateful/initializers.py>`_ or `docs <https://lets-unify.ai/docs/ivy/neural_net_stateful/initializers.html>`_ for more details.

...
def create_args_kwargs(
    *,
    ...
    # create kwargs
    kwarg_array_vals = [
        ivy.array(x, dtype=ivy.as_native_dtype(d))
...
def gradient_test():
    ...
    as_variable_flags = jsonpickle.loads(make_json_pickable(input()))
    native_array_flags = jsonpickle.loads(make_json_pickable(input()))
    container_flags = jsonpickle.loads(make_json_pickable(input()))
...
def method_test():
    ...
    init_flags_as_variable = jsonpickle.loads(make_json_pickable(input()))
    init_flags_native_arrays = jsonpickle.loads(make_json_pickable(input()))
    args_gt_constructor, kwargs_gt_constructor, _, _, _  = create_args_kwargs(
        ...
        as_variable_flags=init_flags_as_variable,
        native_array_flags=init_flags_native_arrays,
    )
...
if __name__ == "__main__":
    ...
    while j:
        try:
            ...
            with_out=jsonpickle.loads(make_json_pickable(input()))

...
.. raw:: html
    ...
    <a href="https://github.com/ivy-dl/ivy/actions?query=workflow%3Atests">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/ivy-dl/ivy/tests?label=tests">
    </a>

...
.. raw:: html
    ...
    <a href="https://github.com/ivy-dl/ivy/actions?query=workflow%3Apypi-tests">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/ivy-dl/ivy/pypi-tests?label=pypi">
    </a>
...
and differentiable gym environments. Click on the icons below for their respective github pages.
...
or if you would like to implement parts of your own project in Ivy to maximise it's portability,

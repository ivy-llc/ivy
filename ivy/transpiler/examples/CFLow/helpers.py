from typing import Union, Type, List, Any, Callable, Optional
import argparse
import math
...
class Config:
    def __init__(self):
        self.dataset = "mvtec"
        self.checkpoint = ""
        self.class_name = "bottle"
        self.enc_arch = "wide_resnet50_2"
        self.dec_arch = "freia-cflow"
        self.pool_layers = 3
        self.coupling_blocks = 8
        self.run_name = 0
        self.input_size = 256
        self.action_type = "norm-train"
        self.batch_size = 32
        self.lr = 2e-4
        self.meta_epochs = 25
        self.sub_epochs = 8

...
class ContainerWithManipulation(ContainerBase):
    ...
    def static_flip(
        ...
        *,
        ...
        -------
        ret
            an output container having the same data type and shape as``x`` and whose elements,
    ...
    def flip(
        ...
        *,
        ...
        -------
        ret
            an output container having the same data type and shape as``self`` and whose elements,
            relative to ``self``, are reordered.

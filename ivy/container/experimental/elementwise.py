...
class ContainerWithElementWiseExperimental(ContainerBase):
    ...
    def static_digamma(
        ...
        *,
        ...
        """
        ivy.Container static method variant of ivy.digamma. This method simply wraps
    ...
    def digamma(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.digamma. This method simply
        wraps the function, and so the docstring for ivy.digamma also applies to this
        method with minimal changes.

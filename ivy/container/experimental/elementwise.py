...
class ContainerWithElementWiseExperimental(ContainerBase):
    ...
    @staticmethod
    def static_arccos(
        x: Union[ivy.Container, ivy.Array, ivy.NativeArray, list, tuple, float, int],
        /,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str]]] = None,
        to_apply: bool = True,
        ...
        """
        ivy.Container static method variant of ivy.arccos. This method simply wraps
        the function, and so the docstring for ivy.arccos also applies to this method
        with minimal changes.

        Parameters
        ----------
        x
            Input container containing array-like inputs.
        key_chains
            The key-chains to apply or not apply the method to. Default is ``None``.
        to_apply
            If True, the method will be applied to key_chains, otherwise key_chains
        ...
        -------
        ret
            container including the trigonometric inverse cosine, element-wise

        Examples
        --------
        >>> x = ivy.Container(a=ivy.array([1, -1]),\
        ...                         b=0.5)
        >>> ivy.Container.static_arccos(x)
        {
            a: ivy.array([ 0.   ,  3.14159265]),
    ...
    def arccos(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.arccos. This method simply
        wraps the function, and so the docstring for ivy.arccos also applies to this
        method with minimal changes.

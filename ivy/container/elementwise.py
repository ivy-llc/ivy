...
class ContainerWithElementwise(ContainerBase):
    ...
    def static_round(
        ...
        """
        ivy.Container static method variant of ivy.round.
        This method simply wraps the function, and so the docstring for
        ivy.round also applies to this method with minimal changes.
        ...
        -------
        ret
            a container containing the round of each element in ``x``.
            The returned container must have a numeric data type
            determined by :ref:`type-promotion`.
    ...
    def round(
        ...
        """
        ivy.Container instance method variant of ivy.round.
        This method simply wraps the function, and so the docstring
        for ivy.round also applies to this method with minimal changes.
        ...
        -------
        ret
            a container containing the round of each element in
            ``self``. The returned container must have a numeric
            data type determined by :ref:`type-promotion`.

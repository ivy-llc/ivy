...
class _ArrayWithManipulationExperimental(abc.ABC):
    ...
    def unflatten(
        ...
        *,
        ...
        """
        ivy.Array instance method variant of ivy.unflatten. This method simply wraps the
        function, and so the docstring for ivy.unflatten also applies to this method
        with minimal changes.

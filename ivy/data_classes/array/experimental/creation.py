...
class _ArrayWithCreationExperimental(abc.ABC):
    ...
    def unsorted_segment_sqrt_n(
        ...
        -------
        ret : ivy.Array
            The output array, representing the result of a segmented sqrt_n operation.
            For each segment, it computes the squared root of the number of elements
            in `self` where `segment_ids` equals to segment ID.

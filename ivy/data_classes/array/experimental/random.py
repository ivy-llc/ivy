...
class _ArrayWithRandomExperimental(abc.ABC):
    ...
    def multivariate_normal(
        ...
        *,
        ...
        """
        ivy.Array instance method variant of ivy.multivariate_normal. This method simply
        wraps the function, and so the docstring for ivy.multivariate_normal also
        ...
        return ivy.multivariate_normal(
            self, cov=cov, size=size, dtype=dtype, seed=seed, out=out
        )

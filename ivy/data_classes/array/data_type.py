...
class _ArrayWithDataTypes(abc.ABC):
    ...
    def dtype(
        ...
        """
        `ivy.Array` instance method variant of `ivy.dtype`. This method helps to 
        ...
        self
            The input array.
        as_native
            Whether to return the native data type of the array. If True, returns the native data type.
            Default is False.

        Returns
        -------
        ret
            The data type of the array. If as_native is True, returns the native data type.

        Examples
        -------
        >>> x = ivy.array([1, 2, 3], dtype=ivy.int32)
        >>> y = x.dtype()
        >>> print(y)
        int32

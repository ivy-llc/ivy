...
class _ContainerWithSet(ContainerBase):
    ...
    def difference(
        ...
        *,
        ...
        -------
        ret
            a container containing the set union of the two containers.
        Examples
        --------
        >>> x = ivy.Container(a=ivy.array([1., 2., 3., 5.]), b=ivy.array([5., 2., 6., 7., 8.]))
        >>> y = ivy.Container(a=ivy.array([3., 45., 3., 4.]), b=ivy.array([5., 1., 4., 7., 6.]))
        >>> z = x.union(y)
        >>> print(z)
        {
            a: ivy.container([1., 2., 3., 5., 6., 7., 8.]),
            b: ivy.container([5., 2., 6., 7., 8., 1., 4., ])
        }
        """

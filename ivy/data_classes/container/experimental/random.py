...
class _ContainerWithRandomExperimental(ContainerBase):
    ...
    @staticmethod
    def static_multivariate_normal(
        mean: ivy.Container,
        cov: ivy.Container,
        /,
        *,
        ...
        """
        ivy.Container static method variant of ivy.multivariate_normal. This method
        simply wraps the function, and so the docstring for ivy.multivariate_normal also
        applies to this method with minimal changes.

        Parameters
        ----------
        mean
            mean of the n-dim distribution
        cov
            cov matrix of the n-dim distribution
        size
            optional container including ints or tuple of ints, 
            Output shape for the arrays in the input container. 
        dtype
    ...
    def multivariate_normal(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.multivariate_normal. This method
        simply wraps the function, and so the docstring for ivy.multivariate_normal also
        applies to this method with minimal changes.
        ...
        """
        return self.static_multivariate_normal(
            self,
            cov=cov,
            size=size,
            dtype=dtype,

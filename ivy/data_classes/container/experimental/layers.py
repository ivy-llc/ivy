...
class _ContainerWithLayersExperimental(ContainerBase):
    ...
    def static_ifftn(
        ...
        *,
        ...
        """
        ivy.Container static method variant of ivy.ifftn. This method simply wraps the
        function, and so the docstring for ivy.ifftn also applies to this method with
        minimal changes.

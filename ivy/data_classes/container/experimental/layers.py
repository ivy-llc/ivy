...
class _ContainerWithLayersExperimental(ContainerBase):
    ...
    def gru(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.gru. This method simply
        wraps the function, and so the docstring for ivy.gru also applies to
        this method with minimal changes.
        ...
        where f is sigmoid and g is tanh.

...
class _ContainerWithElementWiseExperimental(ContainerBase):
    ...
    def static_erfinv(
        ...
        *,
        ...
        """
        ivy.Container static method variant of ivy.erfinv. This method simply wraps the
        function, and so the docstring for ivy.erfinv also applies to this method with
        minimal changes.
    ...
    def erfinv(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.erfinv. This method simply wraps
        the function, and so the docstring for ivy.erfinv also applies to this method
        with minimal changes.

    ...
    def static_leaky_relu(
        ...
        *,
        ...
        x
            input container.
        alpha
            the slope of the activation function at x < 0. Default is ``0.01``.
        key_chains
            The key-chains to apply or not apply the method to. Default is ``None``.
        to_apply
            If True, the method will be applied to key_chains, otherwise key_chains
        ...
        -------
        ret
            a container with the leaky relu activation function
            applied element-wise.
        ...
        >>> print(y)
        {
            a: ivy.array([1.0000, -0.0120]),
            b: ivy.array([0.4000, -0.0020])
        }

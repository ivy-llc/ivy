...
class _ContainerWithManipulationExperimental(ContainerBase):
    ...
    def _static_unflatten(
        ...
        *,
        ...
        """
        ivy.Container static method variant of ivy.unflatten. This method simply wraps
        the function, and so the docstring for ivy.unflatten also applies to this method
        with minimal changes.
    ...
    def unflatten(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.unflatten. This method simply wraps
        the function, and so the docstring for ivy.unflatten also applies to this method
        with minimal changes.

...
class _ContainerWithGeneral(ContainerBase):
    ...
    def _static_size(
        ...
        *,
        ...
        """
        ivy.Container instance method variant of ivy.size. This method simply wraps the
        function, and so the docstring for ivy.size also applies to this method with
        minimal changes.

        Parameters
        ----------
        x
            ivy.Container to infer the number of elements for
        key_chains
            The key-chains to apply or not apply the method to. Default is ``None``.
        to_apply
            If True, the method will be applied to key_chains, otherwise key_chains

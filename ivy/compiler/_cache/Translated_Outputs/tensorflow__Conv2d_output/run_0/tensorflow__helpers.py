...
def as_tensorflow_dtype_1(dtype_in: Union[str, str], /):
    return as_tensorflow_dtype(dtype_in)
...
def tensorflow_is_complex_dtype(
    ...
    return "complex" in as_tensorflow_dtype_1(dtype_in)
...
def tensorflow_default_complex_dtype(
    *,
    ...
    if tensorflow_exists(complex_dtype):
        ...
        return str(as_tensorflow_dtype(complex_dtype))
    ...
    return str(as_tensorflow_dtype(ret))
...
def tensorflow_is_float_dtype(
    ...
    return "float" in as_tensorflow_dtype_1(dtype_in)
...
def tensorflow_is_uint_dtype(
    ...
    return "uint" in as_tensorflow_dtype_1(dtype_in)
...
def tensorflow_is_int_dtype(
    ...
    return "int" in as_tensorflow_dtype(dtype_in)
...
def tensorflow_default_dtype(
    *,
    ...
    if tensorflow_exists(dtype):
        ...
        return as_tensorflow_dtype(dtype)
    as_native = tensorflow_default(as_native, False)
    ...
    if as_native:
        return tensorflow_as_native_dtype(ret)
    return as_tensorflow_dtype(ret)
...
def tensorflow_default_float_dtype(
    *,
    ...
    if tensorflow_exists(float_dtype):
        ...
        return str(as_tensorflow_dtype(float_dtype))
    as_native = tensorflow_default(as_native, False)
    if tensorflow_exists(input):
        if tensorflow_is_array(input):
            ret = tensorflow_dtype(input)
...
def tensorflow_default_int_dtype(
    *,
    ...
    if tensorflow_exists(int_dtype):
        ...
        return str(as_tensorflow_dtype(int_dtype))
    as_native = tensorflow_default(as_native, False)
    if tensorflow_exists(input):
        if tensorflow_is_array(input):
            ret = tensorflow_dtype(input)
...
def tensorflow_dtype(
    ...
    *,
    ...
    return as_tensorflow_dtype(x.dtype)
...
def tensorflow_is_bool_dtype(
    ...
    return "bool" in as_tensorflow_dtype(dtype_in)
...
def as_tensorflow_dev(device: str, /):
    ...
    *,
    ...
    if tensorflow_exists(device):
        if as_native is True:
            ...
            return as_tensorflow_dev(device)
        return device
    as_native = tensorflow_default(as_native, False)
    if tensorflow_exists(item):
...
def tensorflow_promote_types(
    ...
    *,
    ...
    query = [as_tensorflow_dtype(type1), as_tensorflow_dtype(type2)]
    query = tuple(query)
...
def tensorflow_default_uint_dtype(
    *,
    ...
    if tensorflow_exists(uint_dtype):
        ...
        return str(as_tensorflow_dtype(uint_dtype))
    as_native = tensorflow_default(as_native, False)
    if tensorflow_exists(input):
        if tensorflow_is_array(input):
            ret = tensorflow_dtype(input)
...
def tensorflow_infer_default_dtype(
    ...
    if tensorflow_is_complex_dtype(dtype):
        ...
        default_dtype = as_tensorflow_dtype("bool")
    return default_dtype


def tensorflow_dtype_bits(dtype_in: Union[tensorflow.DType, str, np.dtype], /):
    dtype_str = as_tensorflow_dtype(dtype_in)
...
def tensorflow_to_scalar_2(self: tensorflow.Tensor):
...
def tensorflow_conv2d(
    input, weight, bias=None, stride=1, padding=0, dilation=1, groups=1
):
    return tensorflow__conv(
        input,
        weight,
        bias=bias,
        stride=stride,
...
def tensorflow_pad_1(
    ...
    **kwargs: Optional[Any],
    ...
    pad_width = tensorflow__to_tf_padding(pad_width, len(input.shape))

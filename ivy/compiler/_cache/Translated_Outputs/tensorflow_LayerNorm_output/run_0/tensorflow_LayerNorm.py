...
from .tensorflow__helpers import tensorflow_layer_norm_frnt
...
class tensorflow_LayerNorm(tensorflow_keras_Model):
    ...
    def __init__(
        ...
        if self.elementwise_affine:
            self.weight = tensorflow.Variable(
                tensorflow_empty_frnt(self.normalized_shape, **factory_kwargs),
                name="tensorflow_LayerNorm/weight",
            )
            if bias:
                self.bias = tensorflow.Variable(
                    tensorflow_empty_frnt(self.normalized_shape, **factory_kwargs),
                    name="tensorflow_LayerNorm/bias",
                )
            else:
    ...
    def call(self, input):
        return tensorflow_layer_norm_frnt(
    ...
    def __repr__(self):
        ...
        if extra_repr:
            with tensorflow.name_scope("tensorflow_LayerNorm/extra_lines"):
    ...
    def _create_variables(self, device=None, dtype=None):
        with tensorflow.name_scope("tensorflow_LayerNorm/v"):
            v = dict(
                OrderedDict(
                    [
                        (k.replace(".", "/"), v)
    ...
    def _replace_update_v(self, new_v, native=None):
        with tensorflow.name_scope("tensorflow_LayerNorm/native"):

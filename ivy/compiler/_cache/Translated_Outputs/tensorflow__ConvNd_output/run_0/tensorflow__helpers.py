...
def tensorflow_split_2(tensor, split_size_or_sections, dim=0):
...
@tensorflow_handle_methods_1
def tensorflow_split_3(arr, split_size, dim=0):
    return tensorflow_split_2(arr, split_size, dim)
...
@tensorflow_handle_methods_1
def tensorflow_add_2(arr, other, *, alpha=1):

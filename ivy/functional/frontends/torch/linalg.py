...
@to_ivy_arrays_and_back
@with_supported_dtypes({"2.1.2 and below": ("float32", "float64", "complex")}, "torch")
...
@with_supported_dtypes(
    {"2.1.2 and below": ("float32", "float64", "complex32", "complex64", "complex128")},
    "torch",
)
...
@to_ivy_arrays_and_back
@with_supported_dtypes(
    {"2.1.2 and below": ("float32", "float64", "complex64", "complex128")}, "torch"
)
...
@to_ivy_arrays_and_back
@with_supported_dtypes({"2.1.2 and below": ("integer", "float", "complex")}, "torch")
def vander(x, N=None):
    if len(x.shape) < 1:

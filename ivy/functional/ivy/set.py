...
def unique_all(
    ...
    generated/signatures.set_functions.unique_all.html>`_ # noqa
...
def unique_inverse(x: Union[ivy.Array, ivy.NativeArray]) -> Tuple[ivy.Array, ivy.Array]:
    ...
    generated/signatures.signatures.set_functions.unique_inverse.html>`_ # noqa
    in the standard. The descriptions above assume an array input for simplicity, but
    the method also accepts :code:`ivy.Container` instances in place of
    :code:`ivy.Array` or :code:`ivy.NativeArray` instances, as shown in the type hints
    and also the examples below.
    ...
    >>> values, inverse_indices = ivy.unique_inverse(x)
    ...
    >>> values, inverse_indices = x.unique_inverse()

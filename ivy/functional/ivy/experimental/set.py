...
def intersection(
    ...
    assume_unique
        Bool. If True, the input arrays are both assumed to be unique, which can speed up the calculation.
        If True but x1 or x2 are not unique, incorrect results and out-of-bounds indices could result.
        Default is False.
    ...
    ret
        ...
        - The indices of the first occurrences of the common values in x1. Only provided if return_indices is True.
        - The indices of the first occurrences of the common values in x2. Only provided if return_indices is True.
    ...
    ivy.array([1, 2, 3, 9])
    """
    return ivy.current_backend(x1, x2).intersection(x1, x2, assume_unique=assume_unique, return_indices=return_indices)

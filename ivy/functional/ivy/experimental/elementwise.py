...
def logcumsumexp(
    ...
    *,
    ...
    """
    Return the logarithm of the cumulative summation of the exponentiation of the
    ...
    x
        Input array.
    axis
        The dimension to do the operation along. -1 means the last dimension.
        The default (None) is to compute the cumsum over the flattened array.
    dtype
        The data type of the output array. This can be float32 or float64.
        If specified, the input tensor is casted
        to dtype before the operation is performed.
        This can help prevent data type overflows.
        The default value is None.
    out
        Optional array for storing the result to.

    Returns
    -------
    ret
        A tensor consisting of the result of the logcumsumexp operator

    Examples
    --------
    >>> x = ivy.arrange(12, dtype='float64')
    >>> data = ivy.reshape(x, (3, 4))
    >>> ivy.logcumsumexp(data)
    [ 0.         1.3132617  2.4076061  3.4401898  4.4519143  5.4561934
    6.4577627  7.4583397  8.458551   9.45863   10.458658  11.458669 ]
    >>> ivy.logcumsumexp(data, axis=0)
    [[ 0.        1.        2.        3.     ]
    [ 4.01815   5.01815   6.01815   7.01815 ]
    [ 8.018479  9.018479 10.018479 11.018479]]
    >>> ivy.logcumsumexp(data, axis=1)

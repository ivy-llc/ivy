...
#      Make bins optional by offering an automatic bins creation like numpy.
...
#      Tensorflow has different limits for the last bin in bins, not considering it
#           (Test example: a = [1, 2, 3], bins = [1, 2])
@to_native_arrays_and_back
@handle_out_argument
@handle_nestable
@handle_exceptions

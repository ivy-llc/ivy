...
def stft(
    ...
    *,
    ...
    ----------
    signal
        Input tensor representing a real or a complex signal. for real input,
        the following shape is expected:[batch_size][signal_lenght][2],where
        [batch-size][signal_lenght][0] represents the real component and [batch_size]
    ...
    window
        ...
        The window must have rank 1 with shape: [window_shape]. It’s an 
        optional value.
    frame_length
        A scalar representationg the size of the DFT.It’s an optional value   
    norm

...
def inv(
    ...
    >>> x = ivy.Container(a=ivy.array([[1., 1., 0.],\
                        [3., 4., 1.], [2., 3, 1.]]),\
                        b=ivy.array([[4., 4., 2.], [1., 1., 1.],\
                        [1., 5., 2.]]), c=ivy.array([[2., 2., 1.],\
                        [5, 2., 1.], [5., 5., 10.]]))
    >>> y = ivy.Container.static_inv(x)
    >>> print(y)
    {
        a: ivy.array([[-6.e+15, 6.e+15, -6.e+15],
                      [6.e+15, -6.e+15, 6.e+15],
                      [-6.e+15, 6.e+15, -6.e+15]]),
        b: ivy.array([[0.375, -0.25, -0.25],
                      [0.125, -0.75, 0.25],
                      [-0.5, 2., 0.]]),
        c: ivy.array([[-3.33e-01, 3.33e-01, -5.55e-18],
                      [1.00e+00, -3.33e-01, -6.67e-02],
                      [-3.33e-01, 1.85e-17, 1.33e-01]])
    }

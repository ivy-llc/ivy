...
def eigvalsh(
    ...
    *,
    ...
    ivy.array([[-1.45033181e+00,  1.02829754e+00,  1.54220343e+01],
       [-1.18198260e-15,  4.38447177e-01,  4.56155300e+00]])
    ...
    >>> print(y)
    {
        ...
        b: ivy.array([[-1., 1., 4.]]),
        c: ivy.array([[-9.86076132e-32, 5.35898387e-01, 7.46410179e+00]])
    }

    >>> x = ivy.Container(a=ivy.array([[[1.,2.,3.],[2.,4.,5.],[3.,5.,8.]]]),
    ...                     b=ivy.array([[[2.,2.,2.],[2.,3.,3.],[2.,3.,3.]]]))
    >>> y = x.eigvalsh()
    >>> print(y)
    {
        a: ivy.array([[-0.12979878, 0.6156413, 12.5141573]]),
        b: ivy.array([[-9.86076132e-32, 5.35898387e-01, 7.46410179e+00]])
    }
    """

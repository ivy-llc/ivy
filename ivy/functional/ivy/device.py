...
def dev(
    ...
    """
          ...
          Parameters
          ----------
          x: Tensor array for which to get the device handle.

          as_str: Whether or not to return the dev in string format. Default is False.

          Returns
          -------
          out : Device handle for the array, in native framework format.

...
def default_int_dtype(
    *,
    ...
    ----------
    input
         (Default value = None) Number or array for inferring default uint dtype.
    int_dtype
         (Default value = None) int dtype to be returned as default.
    as_native
    ...
    Examples
    ________
    >>> ivy.set_default_int_dtype(ivy.intDtype("uint16"))

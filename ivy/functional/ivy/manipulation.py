...
def repeat(
    ...
    This method conforms to the `Array API Standard
    <https://data-apis.org/array-api/latest/>`_. The descriptions above assume an array input for simplicity, but
    the method also accepts :code:`ivy.Container` instances in place of
    :code:`ivy.Array` or :code:`ivy.NativeArray` instances, as shown in the type hints
    and also the examples below.
    ...
    >>> x = ivy.array([[1.2, 2.5, 3.4], [4.6, 5.1, 6.4],[-7, 0.8, 19], [10.5, 1.1, -12]])
    ...
    >>> print(x)
    iivy.array([[  1.2,   2.5,   2.5,   3.4,   3.4,   3.4],
           [  4.6,   5.1,   5.1,   6.4,   6.4,   6.4],
           [ -7. ,   0.8,   0.8,  19. ,  19. ,  19. ],
           [ 10.5,   1.1,   1.1, -12. , -12. , -12. ]])
    ...
    >>> x = ivy.Container(a=ivy.array([10., 11., 12.]), b=ivy.array([13., 14., 15.]))
    >>> y = x.repeat(2)
    >>> print(y)
    {

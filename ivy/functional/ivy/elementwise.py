...
def acosh(
    ...
    **Special cases**
    ...
    >>> x = ivy.array([3.5, 7, 6, 1.3, 4])
    >>> y = ivy.acosh(x)
    >>> print(y)
    ivy.array([1.92, 2.63, 2.48, 0.756, 2.06])

    >>> x = ivy.array([2, 1.75, 1.9, 1])
    >>> y = ivy.zeros(4)
    >>> ivy.acosh(x, out=y)
    >>> print(y)
    ivy.array([1.32, 1.16, 1.26, 0.])

    >>> x = ivy.array([[1.2, 1.4, 1.6], \
                       [1.8, 1, 2]])
    >>> ivy.acosh(x, out=x)
    >>> print(x)
    ivy.array([[0.622, 0.867, 1.05],
               [1.19, 0., 1.32]])
    
    With :code:`ivy.NativeArray` input:

    >>> x = ivy.native_array([1, 2.6, 155, 3])
    >>> y = ivy.acosh(x)
    >>> print(y)
    ivy.array([0., 1.61, 5.74, 1.76])

    With :code:`ivy.Container` input:
    
    >>> x = ivy.Container(a=ivy.array([5., 1, 2]),\
                            b=ivy.array([4.2, 5.3, 1, 2.3]))
    >>> y = ivy.acosh(x)
    >>> print(y)
    {
        a: ivy.array([2.29, 0., 1.32]),
        b: ivy.array([2.11, 2.35, 0., 1.48])
    }

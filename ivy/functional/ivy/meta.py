...
def reptile_step(
    ...
    *,
    ...
    inner_optimization_step
        The function used for the inner loop optimization.
        It takes the learnable weights,the derivative of the
        cost with respect to the weights, and the learning rate as
    ...
    >>> cost, gradients = ivy.reptile_step(batch,
                                           inner_cost_fn, variables, 5, 0.01,
                                           num_tasks=num_tasks)
    >>> print(cost)
    ivy.array(1.4485182)
    >>> print(gradients)

...
def poisson(
    ...
    *,
    ...
    >>> lam = ivy.array([[1.,2.], [2.,3.]])
    >>> ivy.poisson(lam)
    ivy.array([[1., 1.],
              [0., 4.]])

    >>> lam = ivy.array([[1.,2.], [2.,3.]])
    >>> ivy.poisson(lam, shape=(3,2,2))
    ivy.array([[[1., 5.],
               [1., 2.]],
               [[0., 0.],
               [2., 6.]],
    ...
    >>> lam = ivy.array([[1.,2.], [2.,3.]])
    >>> ivy.poisson(lam, shape=(3,2,2), seed=47)
    ivy.array([[[0., 5.],
               [2., 1.]],
               [[0., 2.],
               [2., 2.]],
    ...
    >>> lam = ivy.Container(a=ivy.array([[1,2], [4,5], [3,1]]),
    ...                     b=ivy.array([1,4,3,2]))
    >>> ivy.poisson(lam, dtype=ivy.float16)
    {
        a: ivy.array([[1., 5.],
                      [6., 9.],
                      [2., 2.]]),

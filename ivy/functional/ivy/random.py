...
def random_stateless_uniform(
    *,
    ...
    """Peforms like random_uniform() but in a stateless way: seed is passed to random_stateless_uniform() directly without
       having to call seed().
       ...
       """
    return ivy.current_backend().random_stateless_uniform(
        low=low, high=high, shape=shape, device=device, dtype=dtype, out=out, seed=seed
    )

...
def stack_images(images: List[np.ndarray], desired_aspect_ratio: Tuple[int, int] = (1, 1)) -> np.ndarray:
    """
      Stacks a group of images in matrix's into a combined windowed image, fitting the desired aspect ratio as closely as possible.
       ...
       -------
      out:
         an ndarray containing the stacked images in the specified dimensions
    """

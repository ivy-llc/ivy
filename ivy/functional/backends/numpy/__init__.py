...
valid_float_dtypes = {"1.24.2 and below": (ivy.float16, ivy.float32, ivy.float64)}
valid_uint_dtypes = {
    "1.24.2 and below": (ivy.uint8, ivy.uint16, ivy.uint32, ivy.uint64)
}
valid_complex_dtypes = {"1.24.2 and below": (ivy.complex64, ivy.complex128)}
...
# invalid data types
# update these to add new dtypes
invalid_dtypes = {"1.24.2 and below": (ivy.bfloat16,)}
invalid_numeric_dtypes = {"1.24.2 and below": (ivy.bfloat16,)}
invalid_int_dtypes = {"1.24.2 and below": ()}
invalid_float_dtypes = {"1.24.2 and below": (ivy.bfloat16,)}
invalid_uint_dtypes = {"1.24.2 and below": ()}
invalid_complex_dtypes = {"1.24.2 and below": ()}

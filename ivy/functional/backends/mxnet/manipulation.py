...
def constant_pad(
    x, /, pad_width, *, value=0, out: Optional[Union[(None, tf.Variable)]] = None
):
    raise NotImplementedError("mxnet.constant_pad Not Implemented")


def zero_pad(x, /, pad_width, *, out: Optional[Union[(None, tf.Variable)]] = None):
...
def clip(
    x: Union[(None, tf.Variable)],
    x_min: Union[(Number, None, tf.Variable)],
    x_max: Union[(Number, None, tf.Variable)],
    /,
    *,
    out: Optional[Union[(None, tf.Variable)]] = None,
) -> Union[(None, tf.Variable)]:

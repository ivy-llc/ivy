...
def random_uniform(
    *,
    low: Union[(float, None, tf.Variable)] = 0.0,
    high: Union[(float, None, tf.Variable)] = 1.0,
...
def random_normal(
    *,
    mean: Union[(float, None, tf.Variable)] = 0.0,
    std: Union[(float, None, tf.Variable)] = 1.0,
...
def multinomial(
    ...
    *,
    batch_size: int = 1,
    probs: Optional[Union[(None, tf.Variable)]] = None,
    replace: bool = True,
    device: str,
    seed: Optional[int] = None,
    out: Optional[Union[(None, tf.Variable)]] = None,
...
def randint(
    low: Union[(float, None, tf.Variable)],
    high: Union[(float, None, tf.Variable)],
    /,
    *,
    shape: Optional[Union[(ivy.NativeShape, Sequence[int])]] = None,
    device: str,

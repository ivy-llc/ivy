...
valid_uint_dtypes = {
    "0.4.17 and below": (ivy.uint8, ivy.uint16, ivy.uint32, ivy.uint64)
}
valid_float_dtypes = {
    "0.4.17 and below": (ivy.bfloat16, ivy.float16, ivy.float32, ivy.float64)
}
valid_complex_dtypes = {"0.4.17 and below": (ivy.complex64, ivy.complex128)}
...
# update these to add new dtypes
invalid_dtypes = {"0.4.17 and below": ()}
invalid_numeric_dtypes = {"0.4.17 and below": ()}
invalid_int_dtypes = {"0.4.17 and below": ()}
invalid_float_dtypes = {"0.4.17 and below": ()}
invalid_uint_dtypes = {"0.4.17 and below": ()}
invalid_complex_dtypes = {"0.4.17 and below": ()}

...
def clip(
    ...
    *,
    ...
    if x_min is not None:
        ...
        x = jnp.where(x < x_min, jnp.astype(x_min, promoted_type), jnp.astype(x, promoted_type))
    if x_max is not None:
        ...
        x = jnp.where(x > x_max, jnp.astype(x_max, promoted_type), jnp.astype(x, promoted_type))
    return x

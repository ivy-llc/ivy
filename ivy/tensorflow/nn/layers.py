...
conv1d = lambda x, filters, strides, padding, data_format='NWC', dilations=1, filter_shape=None, num_filters=None:\
    _tf.nn.conv1d(x, filters, strides, padding, data_format, dilations)
conv1d_transpose = lambda x, filters, strides, padding, output_shape, data_format='NWC', dilations=1, filter_shape=None, num_filters=None:\
...
conv2d_transpose = lambda x, filters, strides, padding, output_shape, data_format='NHWC', dilations=1, filter_shape=None, num_filters=None:\
...
conv3d_transpose = lambda x, filters, strides, padding, output_shape, data_format='NDHWC', dilations=1, filter_shape=None, num_filters=None:\
    _tf.nn.conv3d_transpose(x, filters, output_shape, strides, padding, data_format, dilations)
linear = lambda x, weight, bias, num_hidden=None: _tf.matmul(x, _tf.transpose(weight)) + bias

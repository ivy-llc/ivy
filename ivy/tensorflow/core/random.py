...
random_uniform = lambda low=0., high=1., shape=None, dev_str=None:\
    _tf.random.uniform(shape if shape else (), low, high)
randint = lambda low, high, shape, dev_str=None: _tf.random.uniform(shape=shape, minval=low, maxval=high, dtype=_tf.int32)

...
class KaimingNormal:
    ...
    def create_variables(self, var_shape, device, fan_out=None, fan_in=None, negative_slope=0.):
        """
        Create internal variables for the layer
        """
        if self._fan_mode == 'fan_in':
        ...
        return ivy.variable(ivy.random_normal(self._mean, std, var_shape, device=device))

...
def reduce_sum(x, axis=None, keepdims=False, f=None):
    ...
    :param axis: Axis or axes along which a sum is performed.
        ...
        If axis is a tuple of ints, a sum is performed on all
...
def reduce_prod(x, axis=None, keepdims=False, f=None):
    ...
    :type x: array
    :param axis: Axis or axes along which a multiplication is performed.
        The default, axis=None, will multiply all of the elements of
            the input array.

        If axis is negative it counts from the last to the first axis.
        If axis is a tuple of ints, a multiplication is performed on all of
            the axes specified in the tuple instead of a single axis or all
             the axes as before.
...
def reduce_mean(x, axis=None, keepdims=False, f=None):
    ...
    :param keepdims: If this is set to True,
        the axes which are reduced are left in the result
...
def reduce_min(x, axis=None, keepdims=False, f=None):
    ...
    Computes the minimum value along the specified axis.
        The minimum is taken over the flattened array by default,
    otherwise over the specified axis.

    :param x: Array containing numbers whose min is desired.
    :type x: array
    :param axis: Axis or axes along which the mins are computed.
        The default is to compute the min of the flattened array.
        If this is a tuple of ints, a min is performed over multiple axes,
        instead of a single axis or all the axes as before.
...
def reduce_max(x, axis=None, keepdims=False, f=None):
    ...
    Computes the maximum value along the specified axis.
        The maximum is taken over the flattened array by default,
    otherwise over the specified axis.

    :param x: Array containing numbers whose max is desired.
    :type x: array
    :param axis: Axis or axes along which the maxes are computed.
        The default is to compute the max of the flattened array.
        If this is a tuple of ints, a max is performed over multiple axes,
        instead of a single axis or all the axes as before.

    :type axis: int or sequence of ints
    :param keepdims: If this is set to True, the axes which are reduced
...
def einsum(equation, *operands, f=None):
    ...
    Sums the product of the elements of the input operands along dimensions
        specified using a notation based on the
    Einstein summation convention.

    :param equation: A str describing the contraction,
        in the same format as numpy.einsum.
    :type equation: str
    :param operands: the inputs to contract (each one an ivy.Array),

...
def random_uniform(low=0.0, high=0.0, size=None, dev='cpu', f=None):
    """
    ...
    """
    return _get_framework(f=f).random_uniform(low, high, size, dev)


def randint(low, high, size, dev='cpu', f=None):
    """
    ...
    :return:
    """
    return _get_framework(f=f).randint(low, high, size, dev)

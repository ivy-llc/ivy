...
def shape(x, f=None):
    ...
    """
    return _get_framework(x, f=f).shape(x)


def get_num_dims(x, f=None):
    """
    ...
    :return: Shape of the array
    """
    return _get_framework(x, f=f).get_num_dims(x)
...
def minimum(x, y, f=None):
    ...
    :type x: array
    :param y: Array containing minimum values, must be broadcastable to x.
    :type y: array
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
...
def maximum(x, y, f=None):
    ...
    :type x: array
    :param y: Array containing maximum values, must be broadcastable to x.
    :type y: array
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
...
def linspace(start, stop, num, axis=None, dev=None, f=None):
    """
    ...
    :return: Array of evenly-spaced values.
    """
    return _get_framework(start, f=f).linspace(start, stop, num, axis, dev)
...
def split(x, num_sections=None, axis=0, f=None):
    ...
    :param x: Array to be divided into sub-arrays.
    :type x: array
...
def expand_dims(x, axis, f=None):
    ...
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
    :return: array with the number of dimensions increased by one.
    """
...
def zeros(shape, dtype_str='float32', dev=None, f=None):
    ...
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
    :return: Array of zeros with the given shape and dtype_str.
    """
...
def zeros_like(x, dtype_str=None, dev=None, f=None):
    ...
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
    :return: Array of zeros with the same shape and type as a, unless dtype_str provided which overrides.
    """
...
def ones(shape, dtype_str='float32', dev=None, f=None):
    ...
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
    :return: Array of ones with the given shape and dtype_str.
    """
...
def one_hot(indices, depth, dev='cpu', f=None):
    """
    ...
    :param f: Machine learning framework. Inferred from inputs if None.
    :type f: ml_framework, optional
    :return: Array of zeros with the same shape and type as a, unless dtype provided which overrides.
    """
    return _get_framework(indices, f=f).one_hot(indices, depth, dev)
...
def gather_flat(params, indices, dev=None, f=None):
    """
    ...
    """
    return _get_framework(params, f=f).gather_flat(params, indices, dev)


def gather_nd(params, indices, indices_shape=None, dev=None, f=None):
    """

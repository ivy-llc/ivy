...
def test_array():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/array.txt'.format(DIM)
    )
...
def test_to_numpy():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/to_numpy.txt'.format(DIM)
    )
...
def test_to_list():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/to_list.txt'.format(DIM)
    )
...
def test_shape():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/shape.txt'.format(DIM)
    )
...
def test_get_num_dims():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/get_num_dims.txt'.format(DIM)
    )
...
def test_minimum():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/minimum.txt'.format(DIM)
    )
...
def test_maximum():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/maximum.txt'.format(DIM)
    )
...
def test_clip():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/clip.txt'.format(DIM)
    )
...
def test_round():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/round.txt'.format(DIM)
    )
...
def test_floormod():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/floormod.txt'.format(DIM)
    )
...
def test_floor():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/floor.txt'.format(DIM)
    )
...
def test_ceil():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/ceil.txt'.format(DIM)
    )
...
def test_abs():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/abs.txt'.format(DIM)
    )
...
def test_argmax():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/argmax.txt'.format(DIM)
    )
...
def test_argmin():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/argmin.txt'.format(DIM)
    )
...
def test_cast():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/cast.txt'.format(DIM)
    )
...
def test_arange():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/arange.txt'.format(DIM)
    )
...
def test_linspace():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/linspace.txt'.format(DIM)
    )
...
def test_concatenate():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/concatenate.txt'.format(DIM)
    )
...
def test_flip():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/flip.txt'.format(DIM)
    )
...
def test_stack():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/stack.txt'.format(DIM)
    )
...
def test_unstack():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/unstack.txt'.format(DIM)
    )
...
def test_split():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/split.txt'.format(DIM)
    )
...
def test_tile():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/tile.txt'.format(DIM)
    )
...
def test_zero_pad():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/zero_pad.txt'.format(DIM)
    )
...
def test_swapaxes():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/swapaxes.txt'.format(DIM)
    )
...
def test_transpose():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/transpose.txt'.format(DIM)
    )
...
def test_expand_dims():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/expand_dims.txt'.format(DIM)
    )
...
def test_where():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/where.txt'.format(DIM)
    )
...
def test_indices_where():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/indices_where.txt'.format(DIM)
    )
...
def test_squeeze():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/squeeze.txt'.format(DIM)
    )
...
def test_zeros():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/zeros.txt'.format(DIM)
    )
...
def test_zeros_like():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/zeros_like.txt'.format(DIM)
    )
...
def test_ones():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/ones.txt'.format(DIM)
    )
...
def test_ones_like():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/ones_like.txt'.format(DIM)
    )
...
def test_one_hot():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/one_hot.txt'.format(DIM)
    )
    ...
    for lib, call in [
        ...
        x0 = ivy_gen.cast(
            ivy_gen.tensor(
                [
                    random.randint(0, int(DIM ** 0.5) - 1)
                    for _ in range(int(DIM**0.5))
                ], f=lib
            ), 'int64'
        )
...
def test_cross():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/cross.txt'.format(DIM)
    )
    ...
    for lib, call in [
        ...
        x0 = ivy_gen.tensor(
            [[random.uniform(0, 1)] * 3 for _ in range(DIM)], f=lib
        )
...
def test_matmul():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/matmul.txt'.format(DIM)
    )
...
def test_cumsum():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/cumsum.txt'.format(DIM)
    )
...
def test_identity():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/identity.txt'.format(DIM)
    )
...
def test_scatter_flat():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/scatter_flat.txt'.format(DIM)
    )
    ...
    for lib, call in [
        ...
        x0 = ivy_gen.tensor(
            [random.randint(0, DIM - 1) for _ in range(DIM)], f=lib
        )
...
def test_scatter_nd():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/scatter_nd.txt'.format(DIM)
    )
...
def test_gather_flat():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/general/gather_flat.txt'.format(DIM)
    )
...
def test_get_device():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/get_device.txt'.format(DIM)
    )
...
def test_dtype():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/general/dtype.txt'.format(DIM)
    )

...
def test_svd():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/linalg/svd.txt'.format(DIM)
    )
...
def test_norm():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/linalg/norm.txt'.format(DIM)
    )
...
def test_inv():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/linalg/inv.txt'.format(DIM)
    )
...
def test_pinv():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/linalg/pinv.txt'.format(DIM)
    )
...
def test_vector_to_skew_symmetric_matrix():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/linalg/vector_to_skew_symmetric_matrix.txt'.format(
            DIM
        )
    )

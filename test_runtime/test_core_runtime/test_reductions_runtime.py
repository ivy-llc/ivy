...
def test_reduce_sum():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/reductions/reduce_sum.txt'.format(DIM)
    )
...
def test_reduce_mean():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/reductions/reduce_mean.txt'.format(DIM)
    )
...
def test_reduce_min():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/reductions/reduce_min.txt'.format(DIM)
    )
...
def test_reduce_max():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/reductions/reduce_max.txt'.format(DIM)
    )

...
def test_relu():
    fname = os.path.join(
        this_file_dir, 'runtime_analysis/{}/activations/relu.txt'.format(DIM)
    )
...
def test_leaky_relu():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/activations/leaky_relu.txt'.format(DIM)
    )
...
def test_sigmoid():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/activations/sigmoid.txt'.format(DIM)
    )
...
def test_softmax():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/activations/softmax.txt'.format(DIM)
    )
...
def test_softplus():
    fname = os.path.join(
        this_file_dir,
        'runtime_analysis/{}/activations/softplus.txt'.format(DIM)
    )

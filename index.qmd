...
<span style="color:#35a835;">Note:</span> Want to use Ivy locally? Check out the local set up instructions [here!](https://unify.ai/docs/ivy/compiler/setting_up.html)
:::

...
def dtype_and_values(
    draw: object,
    *,
    available_dtypes: object = get_dtypes("valid"),
    num_arrays: object = 1,
    abs_smallest_val: object = None,
    min_value: object = None,
    max_value: object = None,
    large_abs_safety_factor: object = 1.1,
    small_abs_safety_factor: object = 1.1,
    safety_factor_scale: object = "linear",
    allow_inf: object = False,
    allow_nan: object = False,
    exclude_min: object = False,
    exclude_max: object = False,
    min_num_dims: object = 0,
    max_num_dims: object = 5,
    min_dim_size: object = 1,
    max_dim_size: object = 10,
    shape: object = None,
    shared_dtype: object = False,
    ret_shape: object = False,
    dtype: object = None,
    array_api_dtypes: object = False,
) -> object:

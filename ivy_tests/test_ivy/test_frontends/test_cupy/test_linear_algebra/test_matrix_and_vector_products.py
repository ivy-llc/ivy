...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.cupy.outer"
    ),
)
def test_cupy_outer(
    dtype_and_x,
...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.cupy.inner"
    ),
)
def test_cupy_inner(
    dtype_and_x,
...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.cupy.linalg.cupy"
    ),
)
...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.cupy.linalg.matrix_power"
    ),
)
def test_cupy_matrix_power(

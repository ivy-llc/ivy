...
def test_tensorflow_instance_and(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,
...
def test_tensorflow_instance_rand(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,
...
def test_tensorflow_instance_or(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,
...
def test_tensorflow_instance_ror(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,
...
def test_tensorflow_instance_truediv(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,
...
def test_tensorflow_instance_rtruediv(dtype_and_x, as_variable, native_array, fw):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_method(
        input_dtypes_init=input_dtype,
        as_variable_flags_init=as_variable,

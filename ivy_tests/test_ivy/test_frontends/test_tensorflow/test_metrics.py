...
@given(
    ...
    from_logits=st.booleans(),
    num_positional_args=helpers.num_positional_args(fn_name= \
                        "ivy.functional.frontends.tensorflow.metrics.binary_crossentropy"),
    native_array=st.booleans(),
)

def test_binary_crossentropy( y_true,
                            dtype_y_pred,
                            from_logits,
                            label_smoothing,
                            as_variable,

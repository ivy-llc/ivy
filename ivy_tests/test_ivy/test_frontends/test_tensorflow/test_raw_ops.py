...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.tensorflow.raw_ops.Sign"
    ),
)
def test_tensorflow_Sign(dtype_and_x, as_variable, num_positional_args, native_array):
    input_dtype, x = dtype_and_x
    helpers.test_frontend_function(
        input_dtypes=input_dtype,
        as_variable_flags=as_variable,
...
@given(
    ...
    size_splits_num_split=_get_splits(with_list=True),
)
def test_tensorflow_SplitV(
    dtype_value, size_splits_num_split, axis, as_variable, native_array
):
    dtype, value = dtype_value
    size_splits, num_split = size_splits_num_split
    helpers.test_frontend_function(
        input_dtypes=dtype,
        as_variable_flags=as_variable,
        with_out=False,
...
@given(
    ...
    num_positional_args=helpers.num_positional_args(
        fn_name="ivy.functional.frontends.tensorflow.raw_ops.Reciprocal"
    ),
)

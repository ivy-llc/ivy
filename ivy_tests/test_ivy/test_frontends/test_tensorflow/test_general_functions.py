...
def values_and_ndindices(
    ...
    updates_dtype, updates, updates_shape = draw(
        helpers.dtype_and_values(
            available_dtypes=array_dtypes,
            allow_inf=allow_inf,
    ...
    return [x_dtype, indices_dtype, updates_dtype], x[0], indices, updates, updates_shape, x_shape


# tensor_scatter_nd_max
@handle_frontend_test(
    fn_tree="tensorflow.tensor_scatter_nd_max",
...
def test_tensorflow_tensor_scatter_nd_max(
        *,
        x,
        test_flags,
        fn_tree,
    ...
    (val_dtype, ind_dtype, update_dtype), vals, ind, updates, updates_shape, x_shape = x
    shape = vals.shape

...
@handle_frontend_method(
    class_tree=CLASS_TREE,
    init_tree="paddle.to_tensor",
    method_name="exponential_",
)
def test_paddle_tensor_exponential_(
    dtype_x,
    frontend,
    frontend_method_data_param,
    init_flags,
    method_flags,
    on_device,
    backend_fw,
    ...
    helpers.test_frontend_method(
        ...
        method_input_dtypes=input_dtype,
        method_all_as_kwargs_np={},
        frontend_method_data=frontend_method_data_param,
        init_flags=init_flags,
        method_flags=method_flags,
        frontend=frontend,
        on_device=on_device,
...
def test_paddle_tensor_zero_(
    ...
    # Assuming you have custom decorators and testing conventions
    @handle_frontend_method(
        class_tree=CLASS_TREE,
        init_tree="paddle.to_tensor",
        method_name="exponential_",
        # Add other parameters as needed for your testing
    )
    def test_paddle_tensor_exponential_(
        dtype_x,  # Include any necessary parameters here
        frontend,
        frontend_method_data,
        init_flags,
        method_flags,

...
def test_torch_inputs_to_ivy_arrays(dtype_and_x):
...
def test_torch_outputs_to_frontend_arrays(dtype_and_x, dtype):
    x_dtype, x = dtype_and_x
...
def test_torch_to_ivy_arrays_and_back(dtype_and_x, dtype):
    x_dtype, x = dtype_and_x
